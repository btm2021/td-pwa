// Icon component - SVG icons for the app
    ...
    const icons = {
        ...
        chartCandles: (
            <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="1.5">
                <rect x="4" y="8" width="4" height="8" rx="0.5" fill="#00C853" stroke="#00C853" />
                ...
                <rect x="16" y="9" width="4" height="6" rx="0.5" fill="#00C853" stroke="#00C853" />
